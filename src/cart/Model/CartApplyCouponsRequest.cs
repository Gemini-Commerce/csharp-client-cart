...
namespace cart.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cartApplyCouponsRequest")]
    public partial class CartApplyCouponsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartApplyCouponsRequest" /> class.
        /// </summary>
        /// <param name="tenantId">tenantId.</param>
        /// <param name="cartId">cartId.</param>
        /// <param name="couponCodes">couponCodes.</param>
        public CartApplyCouponsRequest(string tenantId = default(string), string cartId = default(string), List<string> couponCodes = default(List<string>))
        {
